const OurReputation = () => {
    return (
        <div className="our-reputation">
            <h2>Our Reputation</h2>
            <div className="reputation-content">
                <p>WATCH.IPTV is a company that has been in the business of providing streaming services for over 10 years. We have built a reputation as a reliable and trustworthy provider of streaming services, with thousands of satisfied customers around the world.
                ...
                We take pride in our reputation as a reliable and trustworthy provider of streaming services, and we strive to maintain it by constantly improving our products and services. Our team is dedicated to ensuring that all our customers receive the best possible experience when using WATCH.IPTV's streaming services, no matter where they are in the world.
                </p>
